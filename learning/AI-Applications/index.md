...
- Algorithms → Understanding model optimization
- System Design → Scaling LLM applications
...
E-commerce
├─ Product recommendations (NLP embeddings)
├─ Customer support (Chatbots)
└─ Inventory automation (N8N)

Manufacturing
├─ Document analysis (NLP)
├─ Quality control (AI with vision)
└─ Process automation (N8N + Agents)

Research
├─ Literature summary (LLM + RAG)
